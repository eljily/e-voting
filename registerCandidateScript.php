...
<?php
    $con = mysqli_connect("localhost:3307", "root", "", "StudentVote") or die (mysqli_error($con));
  ...
  // if(isset($_POST['submitIns'])){
        ...
        $insert_query = "insert into candidate(name, email, contact,slogan) VALUES('$name','$email','$phone','$slogan')";
